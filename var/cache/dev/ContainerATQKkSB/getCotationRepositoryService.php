...
// Returns the private 'App\Repository\CotationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CotationRepository.php';

return $this->privates['App\Repository\CotationRepository'] = new \App\Repository\CotationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
