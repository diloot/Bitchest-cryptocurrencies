...
// Returns the private 'App\Repository\WalletRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\WalletRepository.php';

return $this->privates['App\Repository\WalletRepository'] = new \App\Repository\WalletRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
