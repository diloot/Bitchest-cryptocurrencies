...
class __TwigTemplate_c2382e8c47dd13c9d0eb723633e2e0c64e899939d9beb314ae3d57e699a25680 extends Twig_Template
{
    private $source;
    ...
    <li class=\"list-inline-item\">Connexion</li>
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new Twig_Error_Runtime('Variable "error" does not exist.', 20, $this->source); })())) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new Twig_Error_Runtime('Variable "error" does not exist.', 21, $this->source); })()), "messageKey", []), twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new Twig_Error_Runtime('Variable "error" does not exist.', 21, $this->source); })()), "messageData", []), "security"), "html", null, true);
            echo "</div>
                                ";
        }
        // line 23
        echo "                                <div class=\"form-group\">
                                    <label for=\"_username\">Adresse email</label>
                                    <input class=\"au-input au-input--full\" type=\"text\" name=\"_username\" placeholder=\"Adresse email\" required value=\"";
        // line 25
        ...
        echo "\">
                                ...
                                <div class=\"form-group\">
                                    ...
                                    <input class=\"au-input au-input--full\" type=\"password\" name=\"_password\" placeholder=\"Mot de passe\" required>
                                </div>
...
";
    ...
    {
        return array (  154 => 37,  139 => 25,  135 => 23,  129 => 21,  127 => 20,  123 => 19,  115 => 13,  106 => 12,  88 => 10,  76 => 6,  67 => 5,  47 => 3,  15 => 1,);
    }
...
{% block pageName %}Se connecter{% endblock %}
                    ...
                    <div class=\"login-content\">
                        <div class=\"login-form\">
                            <form action=\"{{path('login_check')}}\" method=\"post\">
                                ...
                                <div class=\"form-group\">
                                    <label for=\"_username\">Adresse email</label>
                                    <input class=\"au-input au-input--full\" type=\"text\" name=\"_username\" placeholder=\"Adresse email\" required value=\"{{ last_username }}\">
                                </div>
                                <div class=\"form-group\">
                                    <label for=\"_password\">Mot de passe</label>
                                    <input class=\"au-input au-input--full\" type=\"password\" name=\"_password\" placeholder=\"Mot de passe\" required>
...
{% endblock %}", "security/login.html.twig", "C:\\xampp\\htdocs\\Symfony\\bitchest\\templates\\security\\login.html.twig");
    }
}
