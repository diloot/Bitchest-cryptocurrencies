...
// Returns the private 'App\Repository\CryptoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CryptoRepository.php';

return $this->privates['App\Repository\CryptoRepository'] = new \App\Repository\CryptoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
